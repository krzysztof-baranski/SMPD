...
# Project:  SMPD.pro
# Template: app
# Command: C:\Qt\5.8\mingw53_32\bin\qmake.exe -o Makefile SMPD.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug"
#############################################################################
...
Makefile: SMPD.pro C:/Qt/5.8/mingw53_32/mkspecs/win32-g++/qmake.conf C:/Qt/5.8/mingw53_32/mkspecs/features/spec_pre.prf \
